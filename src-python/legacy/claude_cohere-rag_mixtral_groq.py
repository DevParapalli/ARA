...
claude3_sonnet = ChatAnthropic(model_name="claude-3-sonnet-20240229", anthropic_api_key=ANTHROPIC_KEY)
claude2 = ChatAnthropic(model_name="claude-2.1", anthropic_api_key=ANTHROPIC_KEY)
